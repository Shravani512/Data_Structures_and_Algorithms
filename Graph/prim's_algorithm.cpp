...
// to get the sum of minimum spanning tree
// as its name suggest minimun spanning tree thus to get its weight we have to take the edges with minimun edge weight
